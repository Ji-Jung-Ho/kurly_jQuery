<footer id="footer">
    <div class="row1">
        <div class="container">
            <div class="row1-1">
                ...
                <div class="right">
                    <ul>
                        ...
                        <li>
                            <a href="#"><img src="<?=$path?>img/footer/ico_instagram.png" alt=""></a>
                            <a href="#"><img src="<?=$path?>img/footer/ico_fb.png" alt=""></a>
                            <a href="#"><img src="<?=$path?>img/footer/ico_blog.png" alt=""></a>
                            <a href="#"><img src="<?=$path?>img/footer/ico_naverpost.png" alt=""></a>
                            <a href="#"><img src="<?=$path?>img/footer/ico_youtube.png" alt=""></a>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="row1-2">
                <a href="#">
                    <img src="<?=$path?>img/footer/logo_isms.svg" alt="">
                    <span>
                ...
                <a href="#">
                    <img src="<?=$path?>img/footer/logo_privacy.svg" alt="">
                    <span>
                        개인정보보호 우수 웹사이트<br>
                ...
                <a href="#">
                    <img src="<?=$path?>img/footer/logo_tosspayments.svg" alt="">
                    <span>
                        토스페이먼츠 구매안전(에스크로)<br>
                        서비스를 이용하실 수 있습니다.
                    </span>
                ...
                <a href="#">
                    <img src="<?=$path?>img/footer/logo_wooriBank.svg" alt="">
                    <span>
